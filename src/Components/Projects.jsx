              ...
              <CardBody className="project-card">
                ...
                <Stack mt="6" spacing="3">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: " Lobster Two, cursive" }}
                  >
                    Booking.com provides online reservation services. We act as
                    an intermediary (agent) between guests who want to make an
              ...
              <Box style={{ width: "50%", margin: "auto" }}>
                <Flex spacing="2">
                  ...
                  <Link
                    style={{ marginLeft: "10px" }}
                    className="project-deployed-link"
                    href="https://ephemeral-monstera-6c4929.netlify.app/"
                    target={"_blank"}
                  >
                    <Button colorScheme="blue" solid>
                      deloyment
              ...
              <CardBody className="project-card">
                ...
                <Stack mt="6" spacing="3">
                  ...
                  >
                    ...
                    that will help you develop a high-performing team that
                    smashes goals every time.
                  </Text>
                </Stack>
              </CardBody>
              ...
              <CardBody className="project-card">
                ...
                <Stack mt="6" spacing="3">
                  ...
                  >
                    ...
                    newspaper based in Delhi. It is the flagship publication of
                    HT Media, an entity controlled by the K. K. Birla family,
                    and is owned by Shobhana Bhartia.[2]
                  </Text>
                </Stack>
              </CardBody>
              ...
              <CardBody className="project-card">
                ...
                <Stack mt="6" spacing="3">
                  ...
                  <Text
                    ...
                    style={{ fontFamily: " Lobster Two, cursive" }}
                  >
                    Furniture, home accessories, design ideas and inspiration
                    for big dreams and small budgets. A better everyday life
                    begins at home!
                  </Text>
                </Stack>
              </CardBody>
