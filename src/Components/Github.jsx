    ...
    <div>
      ...
      <Box className="Image_Section">
        <Flex>
          ...
          <Image width={"50%"} className="githubImages"
      ...
      <br/>
      <Box className="Image_Section">
        <Image className="githubImages" w={"70%"} src="https://camo.githubusercontent.com/5bf0ce40ce33b017173dba7f84078666d4014009631652611b25b355dfbb7539/68747470733a2f2f6769746875622d726561646d652d73747265616b2d73746174732e6865726f6b756170702e636f6d2f3f757365723d736168696c3932313426" alt="contri" />
      </Box>
    </div>
  );
};
